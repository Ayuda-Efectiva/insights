...
class FrappeDB(MariaDB):
    def __init__(self, data_source, host, port, username, password, database_name, use_ssl, **_):
        ...
        self.engine = get_sqlalchemy_engine(
            ...
            port=port,
            ssl=use_ssl,
            # ssl_verify_cert=True, # DFP: `ssl_verify_cert` linked with `use_ssl` to avoid development environments error
...
class SiteDB(FrappeDB):
    def __init__(self, data_source):
        ...
        self.engine = get_sqlalchemy_engine(
            ...
            ssl=False,
            # ssl_verify_cert=True, # DFP: same value as `ssl` to avoid development environments error
